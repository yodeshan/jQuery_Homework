...
$(document).ready(function() {
  ...
  function randomNumCrystals() {
    return {
      red: {
        ...
        imageUrl: "assets/images/crystalred.jpg"
      },
      blue: {
        points: Math.floor(Math.random() * 12) + 1,
        imageUrl: "assets/images/crystalblue.jpg"
      },
      purple: {
        points: Math.floor(Math.random() * 12) + 1,
        imageUrl: "assets/images/crystalpurple.jpg"
      },
      white: {
        points: Math.floor(Math.random() * 12) + 1,
        imageUrl: "assets/images/crystalwhite.jpg"
      }
    };
  }
  ...
  function randomNumGen() {
    return Math.floor(Math.random() * 88) + 18;
  }
